...
#TEST COLORS AND MEDIAN: xyplot(OSI ~ d.mm | Scan, data = Hemodynamics, groups = Patient, type = "l", lwd=0.5, grid = TRUE, strip=my.strip, 
       #layout=c(1, 3, 1), xlab="Vein Length [mm]", ylab="Oscillatory Shear Index",
