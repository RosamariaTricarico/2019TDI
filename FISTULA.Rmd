...
3. Brachial artery dilation on 50 patients at two time poins (pre- and post-fistula)
Scientific reasoning: Flow-mediated and nitroglycerin-mediated dilation (FMD and NMD, respectively) are utilized for non-invasive assessment of endothelium-dependent and endothelium-independent (smooth muscle cell) vessel functions. 
...
Then I created a Volcano plot to display the distribution of gene expression and marked the genes with p-value > .01 and fold change > 1.3 to identify set of genes that might therefore play a role during fistula remodeling and adaption.
...
By investigating the genomics of all patients which fistula already failied or show hemodynamic signatures of failure, we will be able to obtain a list of genes potenitally involved with fistula failure mechanicsms.
